...
class Missing_Data_Analysis:
    ...
    def Overview_Of_Missing_Data(self, DataFrame):
        ...
        for Column_Name, Column_Value in Number_Of_NaN.iteritems():
            Missing_Data_Overview = Missing_Data_Overview.append({"Missing Data Columns": Column_Name,
                                                                  "Total Missing Data": Column_Value,
                                                                  "Percentage of Missing Data (%)": round((Column_Value/Total_Size_of_Dataframe * 100), 2)},
                                                                 ignore_index=True)
